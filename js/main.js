(function ($) {
  ...
  --------------------------------------------------------------*/
   $(window).scroll(function() {
    ...
    if (scroll >= 60) {
        $('.cs-sticky_header').addClass("cs-gescout_sticky");
        $('.cs-sticky_header').addClass("cs-gescout_show");
    } else {
        $('.cs-sticky_header').removeClass("cs-gescout_sticky");
        $('.cs-sticky_header').removeClass("cs-gescout_show");
    }
});
